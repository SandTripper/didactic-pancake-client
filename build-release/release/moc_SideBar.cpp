...
#include <memory>
#include "../../didactic-pancake-client/SideBar.h"
...
QT_MOC_LITERAL(1, 8, 12), // "changeToChat"
QT_MOC_LITERAL(2, 21, 0), // ""
QT_MOC_LITERAL(3, 22, 14), // "changeToFriend"
QT_MOC_LITERAL(4, 37, 20), // "handleReadMessageNum"
QT_MOC_LITERAL(5, 58, 3), // "num"
QT_MOC_LITERAL(6, 62, 29), // "on_btn_change_to_chat_clicked"
QT_MOC_LITERAL(7, 92, 31) // "on_btn_change_to_friend_clicked"

    },
    "SideBar\0changeToChat\0\0changeToFriend\0"
    "handleReadMessageNum\0num\0"
    "on_btn_change_to_chat_clicked\0"
    "on_btn_change_to_friend_clicked"
};
...
void SideBar::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->changeToChat(); break;
        case 1: _t->changeToFriend(); break;
        case 2: _t->handleReadMessageNum((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 3: _t->on_btn_change_to_chat_clicked(); break;
        case 4: _t->on_btn_change_to_friend_clicked(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SideBar::changeToChat)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (SideBar::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SideBar::changeToFriend)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void SideBar::changeToChat()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void SideBar::changeToFriend()
{
